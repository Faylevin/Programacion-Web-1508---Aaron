...
<body>
   ...
   <div class="row center-align">
       <div class="col s16 m6 offset-m3 card login-box border-radius 19px">
           <form class="col s12" action="logica\actualizarLibro.php" method="POST">
               ...
               <div >
                   <button type="submit" class="btn waves-effect waves-light blue lighten-1">Actualizar</button>
               </div>
           </form>
       </div>
   </div>
