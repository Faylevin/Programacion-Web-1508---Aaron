        ...
        <div>
            <div>
                <div class="center-align">
                    <h4 class="center">Eliminacion de registro exitosa</h4>
                    ...
                    <a class='btn-large waves-effect waves-light purple lighten-1' href='eliminar.php' >Eliminar otro registro</a>
                </div>
            </div>
        </div>
    </div>
